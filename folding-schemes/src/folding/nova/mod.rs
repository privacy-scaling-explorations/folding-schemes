    ...
    for<'a> &'a GC2: GroupOpsBounds<'a, C2, GC2>,
{
    ...
    type CFCommittedInstanceWithWitness = (CycleFoldCommittedInstance<C2>, CycleFoldWitness<C2>);
    ...
    for<'a> &'a GC2: GroupOpsBounds<'a, C2, GC2>,
{
    ...
    fn fold_cyclefold_circuit<T: Transcript<C1::ScalarField>>(
        ...
        Error,
    > {
        fold_cyclefold_circuit::<NovaCycleFoldConfig<C1>, C1, GC1, C2, GC2, FC, CS1, CS2>(
            transcript,
            self.cf_r1cs.clone(),
